        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    lastlogin = table.Column<DateTime>(type: "timestamp(0) with time zone", nullable: false, defaultValueSql: "now()")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    created_at = table.Column<DateTime>(type: "timestamp(0) with time zone", precision: 0, nullable: false, defaultValueSql: "now()"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    asnwered_at = table.Column<DateTime>(type: "timestamp(0) with time zone", precision: 0, nullable: false, defaultValueSql: "now()")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "form_answers_user_id_form_id_key",
                table: "form_answers",
